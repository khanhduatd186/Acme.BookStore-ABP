...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b1b29781-1a13-472c-b082-f6601a6dec42
```

> `b1b29781-1a13-472c-b082-f6601a6dec42` is the password of the certificate, you can change it to any password you want.
